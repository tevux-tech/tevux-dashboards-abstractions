...
class Build : NukeBuild {
    ...
    static AbsolutePath NuspecFilename => RootDirectory / "Tevux.Dashboards.Abstractions" / "Tevux.Dashboards.Abstractions.nuspec";
    static AbsolutePath ProjectFilename => RootDirectory / "Tevux.Dashboards.Abstractions" / "Tevux.Dashboards.Abstractions.csproj";
    ...
    Target GetVersionInfo => _ => _
        ...
        .Executes(() => {
            ...
            var currentVersionString = ExtractVersionString(ProjectFilename, "<Version>", "</Version>");
    ...
    Target Pack => _ => _
        ...
        .Executes(() => {
            ...
            settings = settings.SetBuild(true);
            settings = settings.SetOutputDirectory(OutputDirectory);
            settings = settings.SetProperty("repository", "https://github.com/tevux-tech/tevux-dashboards-abstractions");
            settings = settings.SetProperty("projectUrl", "https://github.com/tevux-tech/tevux-dashboards-abstractions");
    ...
    Target Commit => _ => _
       .DependsOn(PushNugetOrg, PushTevuxTech)
       .Executes(() => {
