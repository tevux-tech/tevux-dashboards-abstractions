...
/// <summary>
/// Somewhat cancels any of the <see cref="ExposedOptionAttribute"/> variants. Useful in scenarios when a derived class changes impementation so much that an exposed property coming from the base class becomes irrelevant for the host application. The base property will still be there for internal consumption, only the host application will disregard it.
/// </summary>
